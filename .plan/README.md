...
3. [Controlled feature exposure](build-03-controlled-feature-exposure.md) — implementation-ready plan saved; Build 2 prerequisites are complete. Implementation has not started.
